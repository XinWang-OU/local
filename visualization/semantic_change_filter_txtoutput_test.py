...
# Assuming 'keywords', 'output_dir', and 'metal_distance_over_time' are defined earlier in your code
key_word_str = "_and_".join(keywords)
file_name = os.path.join(output_dir, f"{key_word_str}_metal.csv")  # 确保文件名以.csv结尾
